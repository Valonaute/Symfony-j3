...
class getCustomersRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CustomersRepository.php';

        return $container->privates['App\\Repository\\CustomersRepository'] = new \App\Repository\CustomersRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
